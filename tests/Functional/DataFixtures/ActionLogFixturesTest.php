...
class ActionLogFixturesTest extends WebTestCase
{
    ...
    public function testFixtures(): void
    {
        ...
        $this->assertSame(0, $actionLogRepository->count([]));
        $this->assertSame(0, $actionLogChangeRepository->count([]));
        ...
        $this->assertGreaterThan(4, $actionLogRepository->count([]));
        $this->assertSame(4, $actionLogRepository->count([
            'user' => $userFixtures->getReference(UserFixtures::REFERENCE_ADMIN),
        ]));
        $this->assertSame(3, $actionLogChangeRepository->count([]));
    }
}
